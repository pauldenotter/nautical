...
module.exports = function DropletActions() {
	 ...
	 * @param {Function} callback
	 * @example
	 *   nauticalClient.dropletActions.disableBackups(123, function(err, reply) {});
	 */
	exports.disableBackups = function(dropletId, callback) {
		doAction(dropletId, 'disable_backups', {}, callback);
	};

	/**
	 * Enable provate networking on the droplet
	 *
	 * @method enablePrivateNetworking
	 * @param {Integer} dropletId
	 * @param {Function} callback
	 * @example
	 *   nauticalClient.dropletActions.enablePrivateNetworking(123, function(err, reply) {});
	 */
	exports.enablePrivateNetworking = function(dropletId, callback) {
		doAction(dropletId, 'enable_private_networking', {}, callback);
	};
	 ...
	 * @param {Function} callback
	 * @example
	 *   nauticalClient.dropletActions.snapshot(123, 'My Snapshot', function(err, reply) {});
	 */
	exports.snapshot = function(dropletId, name, callback) {
		doAction(dropletId, 'snapshot', {name: name}, callback);
	};
